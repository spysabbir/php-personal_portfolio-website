      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            ...
            <p class="text-white">Phone: <?= spy_sabbir_update('theme_default', 'owner_phone_number'); ?></p>
            <p class="text-white">Email: <?= spy_sabbir_update('theme_default', 'owner_email_address'); ?></p>
          </div>
          <div class="col-lg-4">
            <h6 class="text-white mb-4">Follow me:</h6>
            <ul class="social-icons">
              <li>
                <a href="<?= spy_sabbir_update('theme_default', 'facebook_link'); ?>" target="_blank">
                  <ion-icon name="logo-facebook"></ion-icon>
                </a>
              </li>
              <li>
                <a href="<?= spy_sabbir_update('theme_default', 'twitter_link'); ?>" target="_blank">
                  <ion-icon name="logo-twitter"></ion-icon>
                </a>
              </li>
              <li>
                <a href="<?= spy_sabbir_update('theme_default', 'instagram_link'); ?>" target="_blank">
                  <ion-icon name="logo-linkedin"></ion-icon>
                </a>
              </li>
              <li>
                <a href="<?= spy_sabbir_update('theme_default', 'linkedin_link'); ?>" target="_blank">
            ...
            <form id="subscription_form" method="POST" action="subscriber_post.php">
              <div class="input-group">
                ...
                <div class="input-group-append">
                  <button id="subscribe_button" class="btn px-1 text-white" type="button">Subscribe</button>
                </div>
              </div>
              <strong id="subscription_message" class="mt-3"></strong>
            </form>
          </div>
        </div>
      </div>
