                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <img class="hidden w-100 img-fluid img-thumbnail" id="news_new_cover_photo" src="../img/news/<?= spy_sabbir_single_select('news', $_GET['id'])['news_cover_photo'] ?>" alt="News New Cover Photo" />
                                    <script>
